...
printf '\n== Restore PureHTMLBrowser project ==\n'
cat .build/project.b64.part* > "$TOOLS/project.b64"
base64 -d "$TOOLS/project.b64" > "$TOOLS/PureHTMLBrowser.zip"
...
APK="$ROOT/PureHTMLBrowser/app/build/outputs/apk/debug/app-debug.apk"
test -s "$APK"
cp "$APK" "$ROOT/out/PureHTMLBrowser-debug.apk"
